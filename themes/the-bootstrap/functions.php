...
#function the_selection_scripts() {
...
#	wp_enqueue_style("customized_styles", get_template_directory_uri() . "/css/theme_custom.css");
#
#}
#add_action( 'wp_enqueue_scripts', 'the_selection_scripts' );
